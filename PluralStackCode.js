 /**************** INPUT ***************/
                ...
                //these values are not displaying required results
                var shipDetails = ReturnShipDetails(board, 1, 1);
                console.log(shipDetails);
                var shipDetails = ReturnShipDetails(board, 1, 2);
                console.log(shipDetails);
                var shipDetails = ReturnShipDetails(board, 2, 1);
                console.log(shipDetails);
                var shipDetails = ReturnShipDetails(board, 2, 2);
                console.log(shipDetails);
                var shipDetails = ReturnShipDetails(board, 2, 4);
                console.log(shipDetails);
                var shipDetails = ReturnShipDetails(board, a, s);
                console.log(shipDetails);
